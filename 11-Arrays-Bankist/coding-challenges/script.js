...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  const dogsArray = [...newDogsJulia, ...dogsKate];
  console.log(dogsArray);

  dogsArray.forEach(function (dogAge, dogNumber) {
    if (dogAge < 3) {
...
const calcAverageHumanAge = function (ages) {
  ...
  console.log(dogsExcluded);

  const averageAge =
    dogsExcluded.reduce((sum, age) => sum + age, 0) / dogsExcluded.length;
